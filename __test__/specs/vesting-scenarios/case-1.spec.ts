...
describe('SCENARIO TEST - release 0.5% upon listing, 18 months monthly vesting, vesting will start after one month of lockup finished', () => {
  const totalAmount = chance.integer({ min: 1000000, max: 5000000 })
  const lockupAmount = Math.floor(totalAmount * 0.005)
